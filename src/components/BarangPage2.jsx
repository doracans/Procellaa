...
import kursimarkus from "../assets/markus1.png"
        ...
        <div>
            ...
            <div className="flex justify-center bg-[#FEF8EA] pt-16 pb-16">
                <div className="grid lg:grid-cols-2">
                    <div>
                        <img className="ml-14" src={kursimarkus} alt="aboutUs" width={278} height={10} />
                    </div>
                    <div className='justify-center'>
                        <h1 className='font-semibold text-[60px] '>
                            Markus</h1>
                        <p className="pt-3 text-[13px]" >
                        Luxurious comfort and elegance in a premium velvet design. Meticulously <br />
                        crafted for the perfect blend of style and coziness. Elevate your space with <br />
                        Markus, where opulence meets comfort.</p>
      ...
      {kursi.map((item, index) => (
        <div key={index} className='border shadow-lg hover:scale-105 duration-300 rounded-[15px] bg-[#FEF8EA]  mx-3'>
          ...
          <div className='flex justify-between px-2 py-4'>
            ...
            <p>
              <span><button onClick={() => navigate('/Barang3')}  className="bg-black text-white font-semibold py-2 rounded-full px-5 mr-2 border drop-shadow-2xl">Lean More</button></span>
            </p>
          </div>
        </div>
      ))}
